...
-- Volcando datos para la tabla tiendacamisetas.productos: ~0 rows (aproximadamente)
...
-- Volcando datos para la tabla tiendacamisetas.usuarios: ~0 rows (aproximadamente)
